  ...
  try {
    const [rows] = await db.query(`
      SELECT
        ...
        estadoext.name AS estado_extendido,
      ...
      LEFT JOIN glpi_plugin_fields_estadoextendidofielddropdowns estadoext
        ON t.plugin_fields_estadoextendidofielddropdowns_id = estadoext.id
    ...
    rows.forEach(row => {
      ...
      if (!ticketsMap[ticketId]) {
        ticketsMap[ticketId] = {
          ...
          estado_extendido: row.estado_extendido || null,
